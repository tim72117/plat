...
<div class="page7_box_title">勾選要輸出的統計量</div>
    ...
    <p style="margin:0;margin-left:5px; clear:left;font-size:12px">選擇輸出資料小數點後位數<select name="dotmount" style="padding:6px;border-radius: 5px;-webkit-border-radius: 5px;border: 1px solid silver;">
    <?php
    for($i=1;$i<10;$i++){
