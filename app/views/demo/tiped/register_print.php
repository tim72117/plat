...
<table width="800" align="center" cellpadding="0" cellspacing="0" border="1" style="font-size:12pt; font-family:'標楷體'">
  <tr>
	...
	<td width="150" height="50">
        <p><?=Form::radio('', '', true);?>申請新帳號使用權，新帳號為：<?=$user->email?></p>
...
<table width="800" align="center" cellpadding="0" cellspacing="0" border="1" style="font-size:12pt; font-family:'標楷體'">
    ...
    <tr>
        ...
        <td width="300" height="30">
            <p align="center"><?=$user->contact->fax?></p>
        </td>	
    </tr>
    <tr>
...
<table width="800" align="center" cellpadding="0" cellspacing="0" border="1" style="font-family:'標楷體'">
  <tr>
    ...
    <td width="167" rowspan="3">
        <?=Form::radio('', '', $work->department_class == '2')?>中央政府承辦人<br/>
    	<?=Form::radio('', '', $work->department_class == '1')?>縣市政府承辦人<br/>
        <?=Form::radio('', '', $work->department_class == '0')?>校級承辦人<br/>
    </td>
  </tr>
  <tr>
    <td width="233" style="font-size:10pt;">師資培育整合資料庫</td>
    <td width="268" style="font-size:10pt;">
        <?=Form::checkbox('', '',false)?>師資培育資料庫平台<br />
        （含師資培育整合資料庫線上分析）
    </td>
  </tr>
  <tr>
    ...
    <td style="font-size:10pt;">
        <p><?=Form::checkbox('', '', in_array('use', $contact))?>學校查詢平台</p>
     	<p><?=Form::checkbox('', '', in_array('das', $contact))?>線上分析系統</p>
    </td>
  </tr>
  <tr>
