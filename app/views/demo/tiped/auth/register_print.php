...
<table width="800" align="center" cellpadding="0" cellspacing="0" border="1" style="font-size:12pt">
        ...
        <td>
            ...
            <?php
                foreach($user->schools as $school) {
                    echo $school->id . ' - '. $school->uname . '(' . $school->year . ')';
                    echo '<br />';
                }
                foreach($user->departments as $department) {
                    echo $department->id . ' - ' . $department->dep_name;
                    echo '<br />';
                }
            ?>
            </p>
    ...
    <tr>
        ...
        <td>
            <p style="padding-left:10px"><?=$contact->title?></p>
        </td>   
    </tr>
    <tr>
        <th width="100" height="30">電話</th>
        <td width="300" height="30">
            <p style="padding-left:10px"><?=$contact->tel?></p>
        </td>   
        <th width="100" height="30">傳真</th>
        <td width="300" height="30">
            <p style="padding-left:10px"><?=$contact->fax?></p>
        </td>   
    </tr>
    <tr>
