...
<table style="height:150px">
    ...
    <td><ul name="select_box" group="3" max_select="10" class="muit"></ul><span name="hints" style="color:#999"><img src="/analysis/images/warning.png" />選擇題目後點選向右箭頭加入題目<br /><span style="color:#F00">(限選十題)</span></span></td>
    </tr>
</table>
...
<table width="90" border="0" cellspacing="0" cellpadding="0">
	...
	<tr><td height="25"> <input type="checkbox" name="target_group" ext5="1" value="2" />公立</td></tr>
	<tr><td height="25"> <input type="checkbox" name="target_group" ext5="1" value="3" />私立</td></tr>
</table>
</div>
<div class="page7-box2"name="3type" type="1">
<table width="90" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr><td height="25"> <input type="checkbox" name="target_group" ext5="1" value="4" />一般大學</td></tr>
	<tr><td height="25"> <input type="checkbox" name="target_group" ext5="1" value="5" />技職學校</td></tr>   
</table>
</div>
<div class="page7-box2" name="3type" type="1">
<table width="200" border="0" cellspacing="0" cellpadding="0">
	...
	<tr><td> <input type="checkbox" name="target_group" ext5="1" value="6" />公立一般大學</td><td> <input type="checkbox" name="target_group" ext5="1" value="7" />公立技職</td></tr>
	<tr><td> <input type="checkbox" name="target_group" ext5="1" value="8" />私立一般大學</td><td> <input type="checkbox" name="target_group" ext5="1" value="9" />私立技職</td></tr>
</table>
</div>
