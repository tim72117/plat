...
<script type="text/javascript" src="<?=ques_url('js/jquery-1.10.2.min.js')?>"></script>
<script type="text/javascript" src="<?=ques_url('js/jquery-ui-1.10.3.custom.min.js')?>"></script>
<script type="text/javascript" src="<?=ques_url('js/timer.js')?>"></script>
<script type="text/javascript" src="<?=ques_url('js/qcheck_v4.js')?>"></script>
<script type="text/javascript" src="<?=ques_url('js/qcontrol.js')?>"></script>
...
<link href="<?=ques_url('css/page_struct.css')?>" rel="stylesheet" type="text/css" />
<link href="<?=ques_url('css/page_design.css')?>" rel="stylesheet" type="text/css" />
<link href="<?=ques_url('css/input.css')?>" rel="stylesheet" type="text/css" />
<link href="<?=ques_url($qname)?>/resource/css" rel="stylesheet" type="text/css" />
