...
$( function() {
		$("#all_table").on("mouseover",'th.qtype', function() {
        	$(this).editable("save_modify_graduation102.php" ,{
				data   : "{'0':'調查對象','1':'非調查對象'}",
    			type   : "select",
				id        : 'elementid',
				name      : 'newvalue',
	  ...
	  <td>
	    <table cellpadding=4 cellspacing=0 border=0 width=90% align="left">
				...
				<tr>
					...
					<tr>
						<th scope="col" width="50%" <?if ($pmode==0) {echo "bgcolor=#F0F0FD";} else {echo "bgcolor=#ffffff";}?>><span class="head2"><a href="<? //echo $_SERVER['PHP_SELF'].'?pmode=0' ?>">102學年度應屆畢業師資生名單</a></span></th>
								<th scope="col" width="50%" <?if ($pmode==1) {echo "bgcolor=#F0F0FD";} else {echo "bgcolor=#ffffff";}?>><span class="head2"><a href="<? //echo $_SERVER['PHP_SELF'].'?pmode=1' ?>">已刪除102學年度應屆畢業師資生名單</a></span></th>
							</tr>
			</table>
					</td>
				</tr>
