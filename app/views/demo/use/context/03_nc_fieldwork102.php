...
<table cellpadding="3" cellspacing="1" border="0" width="100%" align="center">
	<tr>
	  <td class="header2">&nbsp;102學年度實習師資生</td>
	</tr>
    <tr>
		<td>
...
<?
//[tted_edu_102].[dbo].[fieldwork102_pstat]								
$resultss = DB::table('tted_edu_102.dbo.fieldwork102_pstat')
            ->join('tted_edu_102.dbo.fieldwork102_userinfo', 'tted_edu_102.dbo.fieldwork102_pstat.newcid', '=','tted_edu_102.dbo.fieldwork102_userinfo.newcid');
...
{	
      if($results){
			...
			else if($results->page >='12') echo "<td align='center' scope=col><span><font color=red>填答完成</font></span></td>\n";
