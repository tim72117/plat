...
<table cellpadding="3" cellspacing="1" border="0" width="100%" align="center">
	<tr>
	  <td class="header2">&nbsp;更改101學年度應屆畢業師資生狀態</td>
	</tr>
	<tr>
	  <td>
	    <table cellpadding=4 cellspacing=0 border=0 width=90% align="left">
				...
				<tr>
					...
					<tr>
						<th scope="col" width="50%" <? if ($pmode==0) {echo "bgcolor=#F0F0FD";} else {echo "bgcolor=#ffffff";}?>><span class="head2"><a href="04_modify_graduation101?pmode=0">101學年度應屆畢業師資生名單</a></span></th>
								<th scope="col" width="50%" <? if ($pmode==1) {echo "bgcolor=#F0F0FD";} else {echo "bgcolor=#ffffff";}?>><span class="head2"><a href="04_modify_graduation101?pmode=0">已刪除101學年度應屆畢業師資生名單</a></span></th>
							</tr>
			</table>
					</td>
				</tr>
			...
			<table cellpadding=4 cellspacing=0 border=0 align="left" width="95%">
				...
				<form name="form2" method="post" action="04_modify_data.php">
			  	  <p><font color="#FF0000"><? //echo $user; ?> </font>您好：貴校目前共有 <font color="blue" size="+3"><? echo $num_all;?></font> 位狀態為&lt;<font color="red"><?php if($pmode==1){ echo "非101學年度應屆畢業師資生";}else{ echo "101學年度應屆畢業師資生";} ?></font>&gt;之101學年度應屆畢業師資生</p>
...
<?
		...
		if ($pmode == 0)
			$std_pstat = '101學年度應屆畢業師資生';
		else
			$std_pstat = '非101學年度應屆畢業師資生';
