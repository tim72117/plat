	...
	for ($i = 4; $i <= $Import_NewRowCount; $i++) { 
		...
		*/		
		...
		for($step =2;$step <=21;$step++){
			...
			//學號 3 科系所代碼 4 科系中文名稱 5 中文姓名 8 戶籍郵遞區號 11 戶籍地址 12			
		...
		if ($count_error>0){
				...
				$error_str .= "	<td align=\’center\’><b>學校代碼</b></td>
								...
								<td align=\’center\’><b>101學年度核定幼稚園師資職前教育課程修課資格</b></td>
								<td align=\’center\’><b>101學年度核定國民小學師資職前教育修課資格</b></td>
								<td align=\’center\’><b>101學年度核定中等學校師資職前教育修課資格</b></td>
								<td align=\’center\’><b>101學年度核定特殊教育師資職前教育課程修課資格</b></td>
	...
	// 顯示欄位錯誤訊息結束-------------------------------------------------------------------				
			...
			if ($i == 4){
				...
				$error_str .= "	<td align=\’center\’><b>學校代碼</b></td>
								...
								<td align=\’center\’><b>性別</b></td> ";
				$error_str .= "</tr>";	 
			$error_str .= "<tr>	<td colspan =20 align=\'center\'><b>資料無誤</b></td> </tr>";
