...
<?
  ...
  $sql = new mod_db();  
  $q_string2 = "select * from [upload102] where school='".$sch_id."' AND type=1 order by cid";
...
<table cellpadding="3" cellspacing="1" border="0" width="100%">
	<tr>
	  <td class="header2">&nbsp;上傳101學年度新進師資生資料</td>
	</tr>
</table>
<table id="newupload" width="95%" align="center" style="display:inline" border="1">
  <tr bgcolor="#FFFFCC">
    <td colspan="8" align="center">上傳101學年度新進師資生資料</td>
  </tr>
  <tr id="gen_content">
	<td colspan="8" align="left" style="padding-left:10px;border-bottom:1px solid black;border-left:1px solid black;">
		<br>※&nbsp;&nbsp;基本資料欄位格式：<a href="../function/download.php?file=newedu101.xls">表格下載</a> /
        									  <a href="../function/download.php?file=newedu101_example.xls">範本下載</a>
		...
		<fieldset style="width:60%;font-size:16px">
            ...
            7.<a href="../function/download.php?file=newedu101QA.doc"><font size="3"><strong>名單上傳Q&amp;A</strong></font></a>
	   </fieldset>
		<br><br>
		  ...
		  <legend>檔案匯入：</legend>
			...
			<form enctype="multipart/form-data" method="POST" name="FileForm1" action="upload_newedu101Data.php" STYLE="margin: 0px; padding: 0px;">
...
?>
<tr>
<td colspan="10" align="left"><input type="button" name="Submit" value="查詢已上傳名單總列表" onClick="location.href='../function/modify_newedu101.php'" style="width:200;height:30;color:#999;background-color:#F00";> </td>
</tr>
  <tr id="gen_content">
