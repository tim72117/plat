...
app.controller('newTableController', function($scope, $http, $filter, $timeout, XLSXReaderService) {
    ...
    //     var columns = $filter('filter')(sheet.tables[0].columns, {changed: true});
    //     if( columns.length < 1 )
    //         return;
    //     console.log(columns);
    ...
    //         });
    //     $http({method: 'POST', url: 'update_columns', data:{} })
