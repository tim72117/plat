<?php
$organizations = [];
Plat\Member::where('project_id', 1)->where('user_id', Auth::user()->id)->first()->organizations->load('now')->each(function($organization) use(&$organizations) {
    $organizations['my-schools-' . $organization->now->id] = ['name' => $organization->now->name, 'shid' => [$organization->now->id]];
});
return [
    'FW' => 'FW_new',
    'groups' => [
        ...
        'no-test' => [
            ...
            'targets' => [
                ...
                'NTR02'          => ['name' => '桃連區', 'city_notest' => '02'],
                'NTR03'          => ['name' => '竹苗區', 'city_notest' => '03'],
                'NTR04'          => ['name' => '中投區', 'city_notest' => '04'],
                'NTR05'          => ['name' => '嘉義區', 'city_notest' => '05'],
                'NTR06'          => ['name' => '台南區', 'city_notest' => '06'],
                'NTR07'          => ['name' => '高雄區', 'city_notest' => '07'],
                'NTR08'          => ['name' => '彰化區', 'city_notest' => '08'],
                'NTR09'          => ['name' => '雲林區', 'city_notest' => '09'],
