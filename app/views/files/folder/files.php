            ...
            <div class="left floated left aligned seven wide column">
                <div ng-dropdown-menu class="ui floating top left pointing labeled icon dropdown basic mini button">
                    ...
                    <div class="menu transition" tabindex="-1">
                        ...
                        <a class="item" href="javascript:void(0)" ng-click="addDoc(6, $event)"><i class="file text outline icon red"></i>調查</a>
                        <a class="item" href="javascript:void(0)" ng-click="addDoc(2, $event)"><i class="file text outline icon red"></i>自訂程式</a>
                    </div>
                </div>
