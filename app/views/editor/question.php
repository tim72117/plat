...
<!--     <div class="ui primary segment">
    ...
    <div class="ui accordion field" ng-if="question.type==='checkbox'">
        ...
        <div class="title" ng-class="{active: question.open.checkboxs}" ng-click="question.open.checkboxs=!question.open.checkboxs">
            <i class="dropdown icon"></i>題目 <a href="javascript:void(0)" ng-click="$event.stopPropagation();addQues(question, 0);question.open.checkboxs=true" title="新增題目"><i class="add icon"></i></a>
        </div>
        ...
        <div class="content" ng-if="question.subs.length > 0" ng-class="{active: question.open.checkboxs}">            
            <div class="ui selection list">                        
                <div class="item" ng-repeat="checkbox in question.subs">   
                    <div class="header">
                        <div class="ui transparent fluid action left icon input" ng-mouseenter="question.open.button[$index]=true" ng-mouseleave="question.open.button[$index]=false">
                            ...
                            <div class="ui icon basic buttons">                                
                                <div class="ui button" ng-click="addQues(checkbox, 0);question.open.subs=true" ng-if="question.open.button[$index]" title="新增子題"><i class="vertically flipped fork icon"></i></div>
                                <div class="ui button" ng-click="answer.reset=!answer.reset" ng-if="question.open.button[$index]" title="清除勾選項目"><i class="refresh icon"></i></div>
                                <div class="ui button" ng-click="removeQues(question.subs, $index)" title="刪除題目"><i class="close icon"></i></div>                                
                            </div>
                        </div>
<!--                         <a href="javascript:void(0)" ng-click="removeQues(question.subs, $index)" title="刪除題目"><i class="close icon"></i></a>
                        <a href="javascript:void(0)" ng-click="answer.reset=!answer.reset" title="清除勾選項目"><i class="refresh icon"></i></a>
    ...
    <div class="ui accordion field" ng-if="question.type==='radio' || question.type==='select'">
        ...
        <div class="title" ng-class="{active: question.open.answers}" ng-click="question.open.answers = !question.open.answers">
            <i class="dropdown icon"></i>選項 <a href="javascript:void(0)" ng-click="$event.stopPropagation();addAns(question.answers, 0);question.open.answers=true" title="新增選項"><i class="add icon"></i></a>
        </div>
                ...
                <div class="item" ng-repeat="answer in question.answers">
                    <div class="header">
                        <div class="ui transparent fluid action left icon input">
                            ...
                            <div class="ui icon basic buttons">                                
                                <div class="ui button" ng-click="addQues(question, 0, answer);question.open.subs=true" title="新增子題" ng-if="question.open.button[$index]"><i class="vertically flipped fork icon"></i></div>
...
<!--                         {{ answer.value }} -  {{ answer.title }}
        ...
        <div class="content" ng-if="question.subs.length > 0" ng-class="{active: question.open.subs}">
            <div class="ui tertiary segment" ng-repeat="answer in question.answers" ng-if="(question.subs | filter:{parent_value: answer.value}).length > 0">
                <!-- <h4 class="ui header">{{ answer.title }}</h4> -->
                <a class="ui green top left attached label">{{ answer.title }}</a>
                <div class="ui vertical segment" ng-repeat="sub in (question.subs | filter:{parent_value: answer.value})" question="sub" layer="0" update="update"></div>
            </div>
        </div>
    ...
    <div class="ui accordion field" ng-if="question.type==='scale'">
        ...
        <div class="title" ng-class="{active: question.open.subs}" ng-click="question.open.subs = !question.open.subs">
            <i class="dropdown icon"></i>題目 <a href="javascript:void(0)" ng-click="$event.stopPropagation();addSub(question.subs, 0);question.open.subs=true" title="新增題目"><i class="add icon"></i></a>
        </div>
    
        <div class="content" ng-if="question.subs.length > 0" ng-class="{active: question.open.subs}">
            <div class="ui bulleted list">
                <div class="item" ng-repeat="sub in question.subs">
                    {{ sub.title }}
                    <a href="javascript:void(0)" ng-click="removeQues(question.subs, $index)" title="刪除子題"><i class="close icon"></i></a>
                </div>
            </div>
        </div>
