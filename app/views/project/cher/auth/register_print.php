...
<table width="800" align="center" cellpadding="0" cellspacing="0" border="1" style="font-size:12pt; font-family:'標楷體';line-height:40px">
    <tr>
        ...
        <td width="300" height="50">
            <p align="left">
            <?php
                Project\Cher\User::find($member->user_id)->departments->each(function($department){
    ...
    <tr>
        ...
        <td width="300" height="30">
            <p align="center"><?=$member->contact->tel?></p>
        </td>
        <td width="100" height="30">
            <p align="center">傳真</p>
        </td>
        <td width="300" height="30">
            <p align="center"><?=$member->contact->fax?></p>
        </td>
    </tr>
    <tr>
        <td width="100" height="30">
        ...
        <td colspan="3" height="30">
            <p align="center"><?=$member->user->email?></p>
        </td>
    </tr>
</table>
...
<table width="800" align="center" cellpadding="0" cellspacing="0" border="0" style="font-size:12px; font-family:'標楷體'">
    <tr>
