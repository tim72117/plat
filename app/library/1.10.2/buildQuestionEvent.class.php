...
--功能說明:
--更新jQuery版本至1.44
--1.sub - 子題控制(radio,select,checkbox(只作用於text))
               - 隱藏 - question:包含題目區答題區(parrent=list例外)(不完整)
                           - question_sub:答題區
               - 清除子題(radio,select,text,checkbox)
               - 關閉子題(radio,select,text,checkbox)
--2.skip - 跳題控制(radio,select)
               - 隱藏題目 - question:包含題目區答題區(parrent=list例外)
                                   - question_sub:答題區
               - 隱藏子題(div[id])
               - 清除子題(radio,select,text,checkbox)
               - 關閉子題(radio,select,text,checkbox)
